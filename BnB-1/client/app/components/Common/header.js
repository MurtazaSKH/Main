              ...
              <div className="col-md-8">
                ...
                <div className="nav-info-bar">
                  <ul className="info-list">
                    <HeaderUser user={this.props.user.user.name} type={this.props.user.user.type} logoutUserProp={this.logout} />
                  </ul>
                </div>
              </div>
      ...
      case 'Admin':
        headerNav = (
          <div>
            ...
            <li><Link to='/AddProduct'>Add/Edit Users</Link></li>
      ...
      case 'Manager':
        headerNav = (
          <div>
            ...
            <li><Link to='/'>Add/Edit Users</Link></li>
            <li><a href="#" onClick={props.logoutUserProp}>Logout</a></li>
          </div>
        );
        break;
